...
axios.default = axios;
const fetchPassword = async (website, username) => {
  try {
    ...
    console.error("Error fetching password:", error2);
    throw error2;
  }
};
const deletePassword = async (website, username) => {
  try {
    ...
    if (error2.response && error2.response.status === 404) {
      console.error("Password not found:", error2.response.data);
      throw new Error("Password not found");
    } else {
      console.error("Error deleting password:", error2);
...
const addPassword = async (website, username, password) => {
  try {
    ...
    console.error("Error adding password:", error2);
    throw error2;
  }
};
const getAllPasswords = async () => {
  try {
    ...
    console.error("Error fetching all passwords:", error2);
    throw error2;
  }
};
const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-60 bg-gray-800 text-white h-full p-4 overflow-y-auto flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold mb-6", children: "Password Manager" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "space-y-2 flex-grow", children: tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        className: `flex items-center w-full p-2 rounded transition-colors ${activeTab === tab.name ? "bg-blue-600" : "hover:bg-gray-700"}`,
        onClick: () => setActiveTab(tab.name),
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(tab.icon, { className: "mr-2", size: 18 }),
          tab.name
        ]
      },
      tab.name
...
const PasswordTable = ({ refreshTable, onRefresh }) => {
  ...
  const handleDelete = async (website, username) => {
    if (window.confirm("Are you sure you want to delete this password?")) {
      try {
        ...
        if (error22.message === "Password not found") {
  ...
  if (error2) return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: error2 });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full mt-4 overflow-auto h-[500px] border rounded shadow", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "min-w-full bg-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2 px-4 border-b bg-gray-100 text-left", children: "Website" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2 px-4 border-b bg-gray-100 text-left", children: "Username" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2 px-4 border-b bg-gray-100 text-left", children: "Created" }),
      " "
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: passwords.map((password) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-4 border-b", children: password.website }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-4 border-b", children: password.username }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "py-2 px-4 border-b", children: [
        password.date,
        " ",
        password.time
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "py-2 px-4 border-b text-right", children: [
...
const AddPasswordForm = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmitadd, className: "w-full p-4 border-t border-gray-300 flex flex-col items-center", children: [
    error2 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500", children: error2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 mr-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "website", className: "block mb-1", children: "Website:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 ml-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "username", className: "block mb-1", children: "Username:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 mr-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "password", className: "block mb-1", children: "Password:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "password",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 ml-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "confirmPassword", className: "block mb-1", children: "Confirm Password:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "password",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 mt-4", children: "Add" })
  ] });
};
const MainContent = ({ activeTab, refreshTable, onRefresh }) => {
  const getTabContent = () => {
    switch (activeTab) {
      case "Passwords":
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-grow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PasswordTable, { onRefresh }, refreshTable) }) });
      case "Add New":
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-grow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AddPasswordForm, { onRefresh }) }) });
      case "Categories":
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-6 overflow-y-auto bg-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-4", children: activeTab }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: getTabContent() })
  ] });
};
const PasswordManagerLayout = () => {
  const [activeTab, setActiveTab] = reactExports.useState("Passwords");
  const [refreshTable, setRefreshTable] = reactExports.useState(false);
  const handleRefresh = () => {
    setRefreshTable(!refreshTable);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex bg-gray-100 w-full h-full", style: { width: "1280px", height: "720px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { activeTab, setActiveTab }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      MainContent,
      {
        activeTab,
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PasswordManagerLayout, {});
}
